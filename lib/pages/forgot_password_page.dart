            ...
            children: [
              Container(
                ...
                child: IconButton(
                  ...
                  icon: const Icon(Icons.arrow_back_ios, size: 28, color: AppTheme.lightBrown),
                ),
              ),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const HeaderText(text: 'Forgot Password?', fontSize: 30,),
                const SizedBox(height: 10,),
                const LightText(text: 'Enter your Email and we will send you a password reset link',),
                const SizedBox(height: 20,),
                Form(
                  key: myFormKey,
                  child: Column(
                ...
                MyElevatedButton(
                  ...
                  child: const LightText(text: 'Reset Password', color: AppTheme.white,),
                ),
              ],
            ),
          )
